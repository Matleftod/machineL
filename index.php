...
https://templatemo.com/tm-568-Underdogs
...
<body class="large-screen">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-7">
          <ul class="info">
            <li><a href="#"><i class="fa fa-envelope"></i>Underdogs@company.com</a></li>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2022 Underdogs Co., Ltd. All Rights Reserved. 
        </div>
      </div>
    </div>
  </footer>
